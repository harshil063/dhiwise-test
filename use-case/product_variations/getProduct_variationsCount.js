/**
 *getProduct_variationsCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of product_variations
 ...
 */
const getProduct_variationsCount = ({
  ...
  let count = await product_variationsDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getProduct_variationsCount;