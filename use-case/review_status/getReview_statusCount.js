/**
 *getReview_statusCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of review_status
...
const getReview_statusCount = ({
  ...
  let count = await review_statusDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getReview_statusCount;